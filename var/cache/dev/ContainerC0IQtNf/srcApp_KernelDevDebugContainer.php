...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getDoctrine_FixturesLoadCommandService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\DataFixtures\\FriendsFixture.php';

        $a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\FriendsFixture(), 'groups' => []]]);
