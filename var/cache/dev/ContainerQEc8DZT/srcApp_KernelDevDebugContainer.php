...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getSecurity_Authentication_Listener_Form_MainService()
    {
        ...
        $b->setOptions(['login_path' => '/dashboard', 'default_target_path' => '/dashboard', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false]);
        ...
        $d->setOptions(['login_path' => '/dashboard', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path']);
